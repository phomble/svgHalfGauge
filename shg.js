(function() { 
	...
	class SHG extends HTMLElement {
		...
		render(val, info, color) {
			...
			if(rounded >=0 && rounded <=100) {
				this.$style.innerHTML = ':host {}.body {background: #BFBFBF;}.metric {padding: 1%;}.metric svg {max-width: 100%;}.metric path {stroke-width: 105;stroke: #ecf0f1;fill: none;}.metric text {font-family: "Lato", "Helvetica Neue", Helvetica, Arial, sans-serif;}.metric.participation path.data-arc {stroke: ' + color + ';}.metric.participation text {fill: ' + color + ';}';
				this.$svg.innerHTML = '<path d="M 950 500 A 450 450 0 0 0 50 500"></path><text class="percentage" text-anchor="middle" alignment-baseline="middle" x="500" y="450" font-size="180" font-weight="bold">' + rounded + '%</text><text class="title" text-anchor="middle" alignment-baseline="middle" x="500" y="550" font-size="90" font-weight="normal">' + info + '</text><path d="' + x + '" class="data-arc"></path>"';
			}
		}
	...
	customElements.define("com-demo-shgauge", SHG);
})();